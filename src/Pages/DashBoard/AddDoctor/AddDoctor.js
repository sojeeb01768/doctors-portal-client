...
const AddDoctor = () => {
    ...
    return (
        <div className='w-96 p-8 shadow-xl '>
            <h2 className='text-4xl font-semibold text-center'>Add A Doctor</h2>
            <form className='' onSubmit={handleSubmit(handleAddDoctor)}>
                ...
                <input className='btn btn-accent w-full max-w-xs' value='Add A Doctor' type="submit" />
...
// where should i save image in DB?
/**
 * Thre places to store image 
